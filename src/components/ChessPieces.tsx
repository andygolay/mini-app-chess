...
export function King({ color, className = '' }: PieceProps) {
  ...
  return (
    <svg viewBox="0 0 45 45" className={className}>
      <g fill={style.fill} stroke={style.stroke} strokeWidth={style.strokeWidth} strokeLinecap="round" strokeLinejoin="round">
        <path d="M22.5 11.63V6M20 8h5" strokeLinejoin="miter" />
        <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5" fill={style.fill} strokeLinecap="butt" strokeLinejoin="miter" />
        <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z" fill={style.fill} />
  ...
  return (
    <svg viewBox="0 0 45 45" className={className}>
      <g fill={style.fill} stroke={style.stroke} strokeWidth={style.strokeWidth} strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" fill="none" stroke={style.stroke} strokeLinejoin="miter" />
      </g>
    </svg>
  );
}
...
export function Knight({ color, className = '' }: PieceProps) {
  ...
  return (
    <svg viewBox="0 0 45 45" className={className}>
      <g fill={style.fill} stroke={style.stroke} strokeWidth={style.strokeWidth} strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21" fill={style.fill} />
        <path d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3" fill={style.fill} />
        <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z" fill={color === 'white' ? '#000' : '#fff'} stroke={color === 'white' ? '#000' : '#fff'} />
        <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill={color === 'white' ? '#000' : '#fff'} stroke={color === 'white' ? '#000' : '#fff'} strokeWidth="1" />
      </g>
    </svg>
  );
}
...
// Component that renders the appropriate piece based on type
